...
const CartItem = ({ onContinueShopping }) => {
  ...
  // Helper function to extract numeric value from cost string (e.g., "$15" -> 15)
  const parseCost = (costString) => {
    if (typeof costString === 'number') return costString;
    // Removes the '$' symbol and parses to float
  ...
  const handleDecrement = (item) => {
    if (item.quantity > 1) {
      ...
      // If quantity drops to 0, completely remove the plant type from the cart
